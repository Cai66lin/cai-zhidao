package com.caizhidao.aspect;

import com.caizhidao.annotation.AutoFill;
import com.caizhidao.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.caizhidao.mapper.*.*(..)) && @annotation(com.caizhidao.annotation.AutoFill)")
